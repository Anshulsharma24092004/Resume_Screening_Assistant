...
connection = pymysql.connect(host='localhost',user='root',password='Anshul24092004',db='cv')
...
def run():
    ...
    link = '<b>Built by <a href="https://github.com/Anshulsharma24092004" style="text-decoration: none; color: #021659;">Anshul Sharma</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>Anshul Sharma</b> as username and <b>mypass@12345</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built by 
            <a href="https://github.com/Anshulsharma24092004" style="text-decoration: none; color: grey;">Anshul Sharma</a> under the guidance of
            <a href="https://www.linkedin.com/in/ashwini-singh-ph-d-b01bb2175/" style="text-decoration: none; color: grey;">Prof. Ashwini Kumar Singh</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'Anshul Sharma' and ad_password == 'mypass@12345':
                ...
                st.success("Welcome Anshul ! Total %d " % values + " User's Have Used Our Tool : )")                
